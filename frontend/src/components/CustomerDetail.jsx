        ...
        <Grid container spacing={2}>
          <Grid sx={{ xs: 6, md: 4 }}>
            <Box display="flex" alignItems="center" mb={1}>
              ...
              <Typography variant="body2">
                <strong>Ngày:</strong> {new Date(appointment.appointment_date).toLocaleDateString('vi-VN')}
              </Typography>
            </Box>
            <Box display="flex" alignItems="center">
              <AccessTime sx={{ mr: 1, color: "primary.main" }} fontSize="small" />
              <Typography variant="body2">
                <strong>Giờ:</strong> {appointment.appointment_time || "Chưa cập nhật"}
              </Typography>
            </Box>
          </Grid>
          <Grid sx={{ xs: 6, md: 4 }}>
            <Typography variant="body2" gutterBottom>
              <strong>Dịch vụ:</strong> {appointment.service_name || "Chưa cập nhật"}
            </Typography>
            <Typography variant="body2">
