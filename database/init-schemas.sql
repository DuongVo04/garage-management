...
CREATE TABLE car_review_appointment (
  id                  varchar(50) NOT NULL, 
...
ALTER TABLE car_review_appointment ADD CONSTRAINT FKcar_review_a883894 FOREIGN KEY (showroom_vehicle_id) REFERENCES showroom_vehicle (id);
